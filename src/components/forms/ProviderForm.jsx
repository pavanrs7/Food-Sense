    ...
    <div className="form-container">
      {success && (
        <div className="form-success">
          ...
          <h3>Food listing added successfully!</h3>
          <p>
            Thank you for your contribution. Your listing is now visible on the
            map.
          </p>
        </div>
      )}
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input
            ...
            required
            placeholder="Restaurant, Event, or Individual Name"
          />
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={handleChange}
            required
            placeholder="e.g., Vegetarian, Non-Vegetarian, Mixed"
          />
        </div>
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            onChange={handleChange}
            placeholder="Provide details about the food, packaging, etc."
          ></textarea>
        </div>
        ...
        >
          {loading ? "Submitting..." : "Add Food Listing"}
        </button>
      </form>
